...
async function bootstrap() {
  ...
  app.enableCors({
    origin: ['http://localhost:3000', 'https://paragraphapi.onrender.com','https://blogpost-paragraphui-re93.vercel.app',"https://blogpost-paragraphui.vercel.app/"], // Birden fazla domain ekledik
